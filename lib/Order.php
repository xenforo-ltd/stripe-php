 ...
 * @property array<\Stripe\OrderItem> $items List of items constituting the order. An order can have up to 25 items.
 ...
 * @property null|array<\Stripe\StripeObject> $shipping_methods A list of supported shipping methods for this order. The desired shipping method can be specified either by updating the order, or when paying it.
