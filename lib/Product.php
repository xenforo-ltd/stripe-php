 ...
 * @property null|array<string> $attributes A list of up to 5 attributes that each SKU can provide values for (e.g., <code>[&quot;color&quot;, &quot;size&quot;]</code>).
 ...
 * @property array<string> $deactivate_on An array of connect application identifiers that cannot purchase this product. Only applicable to products of <code>type=good</code>.
 ...
 * @property array<string> $images A list of up to 8 URLs of images for this product, meant to be displayable to the customer.
