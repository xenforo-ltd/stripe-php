 ...
 * @property null|array<\Stripe\StripeObject> $discount_amounts The amount of discount calculated per discount for this line item.
 * @property bool $discountable If true, discounts will apply to this line item. Always false for prorations.
 * @property null|array<string|\Stripe\Discount> $discounts The discounts applied to the invoice line item. Line item discounts are applied before invoice discounts. Use <code>expand[]=discounts</code> to expand each discount.
 ...
 * @property array<\Stripe\StripeObject> $tax_amounts The amount of tax calculated per tax rate for this line item
 * @property array<\Stripe\TaxRate> $tax_rates The tax rates which apply to the line item.
